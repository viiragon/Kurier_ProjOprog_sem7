                ...
                <asp:Repeater ID="rptPaczki" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Button Text="Szczegóły" OnClick="onClickDetails" runat="server" /></td>
                            <td>
                                <asp:Button Text="Kurier" OnClick="onClickKurier" runat="server" /></td>
                        </tr>
                    ...
                    <AlternatingItemTemplate>
                        <tr>
                            <td><%# Eval("Id") %></td>
                            <td>
                                <asp:PlaceHolder ID="placeholderBlaBlaBla" runat="server" Visible='<%# Convert.ToInt32(Eval("Status.KodStatusu")) == 0 %>'>Nadana
                                </asp:PlaceHolder>
                                <asp:PlaceHolder ID="placeholder1" runat="server" Visible='<%# Convert.ToInt32(Eval("Status.KodStatusu")) == 1 %>'>Doręczona
                                </asp:PlaceHolder>
                            </td>
                            <td>
                                <asp:Button Text="Szczegóły" OnClick="onClickDetails" runat="server" /></td>
